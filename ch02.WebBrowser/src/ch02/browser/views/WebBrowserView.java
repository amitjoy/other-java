...
public class WebBrowserView extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		 ...
		 * http://www.eclipse.org/swt/faq.php#howusemozilla Mozilla requires
		 * XulRunner: http://releases.mozilla.org/pub/mozilla.org/xulrunner
		 * /releases/1.8.1.3/contrib/ XR install: http://developer.mozilla.org
	...
	private void calcSize(CoolItem item) {
		...
		org.eclipse.swt.graphics.Point pt = control.computeSize(SWT.DEFAULT,
				SWT.DEFAULT);
	 ...
	 * browser is changing Don't forget to add a location listener to the
	 * browser widget as follows: browser.addLocationListener(new
	 * LocationListener() { public void changing(LocationEvent event) {
	 * locChanging(event); } });
	 */
