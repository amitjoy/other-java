 ...
 * undone or redone.
 * <p>
 * This command is designed to be used together with a
 * GraphicalNodeEditPolicy. To use this command properly, following steps
 * are necessary:
 * </p>
 * <ol>
 ...
 * obtain the Command from the ConnectionRequest, call setTarget(...) to
 * set the target endpoint of the connection and return this command
 * instance.</li>
 * </ol>
 * 
...
public class ConnectionCreateCommand extends Command {
     ...
     * @param lineStyle
     *            the desired line style. See Connection#setLineStyle(int)
     *            for details
