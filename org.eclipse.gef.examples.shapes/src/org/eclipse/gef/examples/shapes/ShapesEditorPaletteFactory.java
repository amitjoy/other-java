...
final class ShapesEditorPaletteFactory {
    ...
    private static PaletteContainer createShapesDrawer() {
        ...
        CombinedTemplateCreationEntry component = 
            new CombinedTemplateCreationEntry(
                ...
                EllipticalShape.class, new SimpleFactory(
                        EllipticalShape.class), ImageDescriptor
    ...
    /**
     * Creates the PaletteRoot and adds all palette elements. Use this
     * factory method to create a new palette for your graphical editor.
     * 
