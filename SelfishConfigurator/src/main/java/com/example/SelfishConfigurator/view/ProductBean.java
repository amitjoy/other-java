...
public class ProductBean implements Serializable
{
   ...
   private Predicate[] getSearchPredicates(Root<Product> root)
   {
      ...
      {
         predicatesList.add(builder.like(root.<String> get("productName"), '%' + productName + '%'));
      }
      ...
      String longDescription = this.example.getLongDescription();
      if (longDescription != null && !"".equals(longDescription))
      {
         predicatesList.add(builder.like(root.<String> get("longDescription"), '%' + longDescription + '%'));
      }
      ...
      String PDFPath = this.example.getPDFPath();
      if (PDFPath != null && !"".equals(PDFPath))
      {
         predicatesList.add(builder.like(root.<String> get("PDFPath"), '%' + PDFPath + '%'));
      }
