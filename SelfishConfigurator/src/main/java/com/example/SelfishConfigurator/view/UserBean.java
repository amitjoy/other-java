...
public class UserBean implements Serializable
{
   ...
   private Predicate[] getSearchPredicates(Root<User> root)
   {
      ...
      String emailId = this.example.getEmailId();
      if (emailId != null && !"".equals(emailId))
      {
         predicatesList.add(builder.like(root.<String> get("emailId"), '%' + emailId + '%'));
      }
      String mobileNo = this.example.getMobileNo();
      if (mobileNo != null && !"".equals(mobileNo))
      {
         predicatesList.add(builder.like(root.<String> get("mobileNo"), '%' + mobileNo + '%'));
      }
      String phoneNo = this.example.getPhoneNo();
      if (phoneNo != null && !"".equals(phoneNo))
      {
         predicatesList.add(builder.like(root.<String> get("phoneNo"), '%' + phoneNo + '%'));
      }
