...
public class CountryBean implements Serializable
{
   ...
   private Predicate[] getSearchPredicates(Root<Country> root)
   {
      ...
      String countryName = this.example.getCountryName();
      if (countryName != null && !"".equals(countryName))
      {
         predicatesList.add(builder.like(root.<String> get("countryName"), '%' + countryName + '%'));
      }
      String currency = this.example.getCurrency();
      if (currency != null && !"".equals(currency))
      {
         predicatesList.add(builder.like(root.<String> get("currency"), '%' + currency + '%'));
      }
