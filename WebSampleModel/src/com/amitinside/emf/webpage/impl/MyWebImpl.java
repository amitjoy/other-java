/**
 */
package com.amitinside.emf.webpage.impl;

import com.amitinside.emf.webpage.MyWeb;
import com.amitinside.emf.webpage.Webpage;
import com.amitinside.emf.webpage.WebpagePackage;
 ...
 * <ul>
 *   <li>{@link com.amitinside.emf.webpage.impl.MyWebImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.amitinside.emf.webpage.impl.MyWebImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link com.amitinside.emf.webpage.impl.MyWebImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link com.amitinside.emf.webpage.impl.MyWebImpl#getKeywords <em>Keywords</em>}</li>
 *   <li>{@link com.amitinside.emf.webpage.impl.MyWebImpl#getEReference0 <em>EReference0</em>}</li>
 *   <li>{@link com.amitinside.emf.webpage.impl.MyWebImpl#getPages <em>Pages</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MyWebImpl extends MinimalEObjectImpl.Container implements MyWeb {
	 ...
	 * @generated
	 */
	public Webpage getEReference0() {
		if (eReference0 != null && eReference0.eIsProxy()) {
			InternalEObject oldEReference0 = (InternalEObject)eReference0;
			eReference0 = (Webpage)eResolveProxy(oldEReference0);
	 ...
	 * @generated
	 */
	public Webpage basicGetEReference0() {
		return eReference0;
	}
	 ...
	 * @generated
	 */
	public void setEReference0(Webpage newEReference0) {
		Webpage oldEReference0 = eReference0;
	...
	public Webpage getPages() {
		if (pages != null && pages.eIsProxy()) {
			...
			pages = (Webpage)eResolveProxy(oldPages);
			if (pages != oldPages) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, WebpagePackage.MY_WEB__PAGES, oldPages, pages));
			}
		}
		return pages;
	}
	 ...
	 * @generated
	 */
	public void setPages(Webpage newPages) {
		Webpage oldPages = pages;
		pages = newPages;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebpagePackage.MY_WEB__PAGES, oldPages, pages));
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case WebpagePackage.MY_WEB__KEYWORDS:
				...
				return;
			case WebpagePackage.MY_WEB__EREFERENCE0:
				setEReference0((Webpage)newValue);
				return;
			case WebpagePackage.MY_WEB__PAGES:
				setPages((Webpage)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case WebpagePackage.MY_WEB__KEYWORDS:
				...
				return;
			case WebpagePackage.MY_WEB__EREFERENCE0:
				setEReference0((Webpage)null);
				return;
			case WebpagePackage.MY_WEB__PAGES:
				setPages((Webpage)null);
				return;
		}
