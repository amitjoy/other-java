...
import com.schneider.dec.rcp.listeners.providers.DevicesViewerSelectionListener;
...
public class DevicesViewPart {
	...
	public void postConstruct(Composite parent) {
		...
		viewer.getTable().addSelectionListener(
				new DevicesViewerSelectionListener(viewer, devicesGroupsView,
		...
		deviceGroupsNameColumnViewer.getColumn().setText("Device Name");
	...
	public void listDevices(
			@UIEventTopic(EventConstants.SHOW_DEVICES) final Object data,
		...
		dialog.run(false, false, new IRunnableWithProgress() {
			...
			public void run(IProgressMonitor monitor)
					throws InvocationTargetException, InterruptedException {
				monitor.beginTask(
						"Fetching Devices Names Under Group " + data.toString(),
						100);
				for (int i = 0; i < 5; i++) {
