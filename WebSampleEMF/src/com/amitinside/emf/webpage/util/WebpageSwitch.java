...
public class WebpageSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case WebpagePackage.MY_WEB: {
				MyWeb myWeb = (MyWeb)theEObject;
				T result = caseMyWeb(myWeb);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>My Web</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>My Web</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMyWeb(MyWeb object) {
		return null;
	}
